...
final class PhabricatorRussianTranslation extends PhutilTranslation {
  ...
  protected function getTranslations() {
    ...
    return array(
      ...
      'Change Details' => 'Подробности редактирования',
      'Updated' => 'Обновлено',
      'Loading...' => 'Загрузка...',
      'None' => 'Нет',
      ...
      'View Form Configurations' => 'Посмотреть конфигурации форм',
      'Edit Form Configuration' => 'Редактировать конфигурацию формы',
     ...
     '%s edited question(s), added %s: %s; removed %s: %s.' =>
      ...
      'Accepted (by %s)' => 'Принято (%s)',
      'Accepted Prior Diff (by %s)' => 'Принят предшествующее изменение (%s)',
      'Requested Changes (by %s)' => 'Запрошены изменения (%s)',
      'Requested Changes to Prior Diff (by %s)' => 'Запрошены изменения к предшествующему изменению (%s)',
      'Your Phabricator account (%s) has been approved by %s. You can login here:'
        => 'Ваш аккаунт в Фабрикаторе (%s) был одобрен. Вы можете авторизоваться здесь: ',
      ...
      'All Open Objects' => 'Все активные объекты',
      'Current Parent Tasks' => 'Текущие родительские задачи',
      'Current Subtasks' => 'Текущие подзадачи',
      'Save Subtasks' => 'Сохранить подзадачи',
      'Save Parent Tasks' => 'Сохранить родительские задачи',
      'Created By Me' => 'Созданное мною',
      'All Objects' => 'Все объекты',
      'Edit Related Mocks' => 'Редактировать связанные дизайны',
      'Save Related Mocks' => 'Сохранить связанные дизайны',
      'Current Mocks' => 'Текущие дизайны',
      'Edit Related Revisions' => 'Редактировать связанные ревизии',
      'Save Related Revisions' => 'Сохранить связанные ревизии',
      'Current Commits' => 'Текущие фиксации',
      'Edit Related Commits' => 'Редактировать связанные фиксации',
      ...
      'Comment for this transaction was not loaded.' => 'Комментарий для этой транзакции не был загружен',
	    ...
	    'Edit Task: %s' => 'Редактирование задачи: %s',
      ...
      'Feed Story' => 'Лента новостей',
      'An outlandish exaggeration of intricate tales from around the realm.' => 'Необузданное преувеличение запутанных сказок со всего мира.',
      ...
      'Document History: %s' => 'История документа: %s',
      'Show Change' => 'Показать изменение',
      'Show Later Changes' => 'Последующие',
      'No later changes' => 'Нет последующих изменений',
      'No previous change' => 'Нет изменений',
      'Version %s' => 'Версия %s',
      'Version %d (%s)' => 'Версия %d (%s)',
      'Latest Version %s' => 'Последняя версия %s',
      'View Version %d' => 'Показать версию %d',
      'Fragment Version %d: %s' => 'Фрагмент версии %d: %s',
      'Version %s vs %s' => 'Версия %s против %s',
      'Revert to Version %s...' => 'Откатить на версию %s',
      '%s by %s' => '%s за авторством %s',
      '%s by %s, %s' => '%s за авторством %s, %s',
      "You are amending the revision '%s' but you are not the author. Amend this revision by %s?"
        => "Вы изменяете ревизию '%s', но вы не являетесь её автором. Изменить эту ревизию за авторством %s?",
      "This %s has revision '%s' but you are not the author. Land this revision by %s?"
        => "%s имеет ревизию '%s', но вы не являетесь её автором. Подключить эту ревизию за авторством %s?",
      'Created by %s' => 'За авторством %s',
      'Created by %s on %s.' => 'За авторством %s в %s.',
      'Edited by %s' => 'Отредактировал(а) %s',
      'This comment was removed by %s.' => 'Этот комментарий был удалён пользователем %s.',
      "\xC2\xAB Previous Change" => "\xC2\xAB Предыдущее изменение",
      "Next Change \xC2\xBB" => "Последующее изменение \xC2\xBB",
      'Edit Current Version' => 'Редактировать текущую версию',
      'Most Recent Change' => 'Самое последнее изменение',
      ...
      'Configure Blog Post Forms' => 'Отредактировать форму поста блога',
      'Configure creation and editing blog posts in Phame.' => 'Отредактировать создание и редактировать постов блогов в Блоге',
      'Blog Post: ' => 'Пост блога: ',
      'Blog' => 'Блог',
      'Blogs' => 'Блоги',
      'Blog: %s' => 'Блог: %s',
      'Create or edit blog posts in Phame.' => 'Создать или редактировать посты в Блоге',
      'Read information about blog posts.' => 'Почитать информацию о постах в блогах.',
      'There aren\'t any visible blog posts.' => 'Здесь нет каких-либо видимых постов.',
      'No one has written any blog posts yet.' => 'Никто ещё не писал каких-то постов.',
      'The author of a blog post can always view and edit it.' => 'Автор поста в блоге всегда может видеть и редактировать его.',
      '%s renamed this blog post from %s to %s.' => '%s переименовал(а) этот пост с %s на %s',
      '%s renamed %s blog post from %s to %s.' => '%s переименовал(а) %s пост блога с %s на %s.',
      'Posts must have a title.' => 'Посты должны иметь заголовок.',
      'The title can be no longer than %s characters.' => [
        'Заголовок не может быть длиннее %s символа.',
        'Заголовок не может быть длиннее %s символов.',
      ],
      'Recent Posts' => 'Последние посты',
      '%s (Preview)' => '%s (предпросмотр)',
      'Unpublished draft by %s.' => 'Неопубликованный черновик от %s.',
      'Archived post by %s.' => 'Архивный пост от %s.',
      'Read more...' => 'Читать далее...',
      'No description.' => 'Нет описания.',
      'About %s' => 'Про %s',
      'Write Post' => 'Написать пост',
      'Search Posts' => 'Искать посты',
      'Manage Blog' => 'Управлять блогом',
      'Create Post' => 'Создать пост',
      'Create New Post' => 'Создать новый пост',
      'Post' => 'Пост',
      'Full Domain' => 'Полный домен',
      'No external domain' => 'Нет внешнего домена',
      'Parent Site' => 'Родительский сайт',
      'No parent site' => 'Нет родительского сайта',
      'Parent Domain' => 'Родительский домен',
